...
\usepackage[bookmarks=true,bookmarksnumbered=true,citecolor=green,colorlinks=true,hyperfigures=true,hyperfootnotes=true,hyperindex=true,linkcolor=red,urlcolor=blue]{hyperref}
