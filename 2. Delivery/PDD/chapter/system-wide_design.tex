...
The security of the data connection is very important for the system to work. Therefore, the system is using the SINE network in case there the commercial network is not available \citep{SINE_artikel}.
