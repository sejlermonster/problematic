...
\label{sec:areaAwaredismounted}

\begin{longtable}{| p{3.5cm} |  p{10cm} | }
	\hline
	\textbf{II-04} &  \textbf{AreaAware Server interface } \\
	\hline
	Version & v0.1 \\
	\hline
	Status & Under development \\
	\hline
	Description & The AreaAware Dismounted Will communicate with the AreaAware Server. AreaAware Dismounted should be able to receive messages from AreaAware Server and distributes these to relevant parties. AreaAware Dismounted should be able to send and recieve events from AreaAware Server. The communication will be over the internet media provided like SINE or Commercial internet. \\
	\hline
	Needed interfaces & AreaAware Dismounted sends messages To AreaAware Server.  \\
	& AreaAware Dismounted receives messages from AreaAware Server. \\
	& AreaAware Dismounted sends events to AreaAware Server  \\
	& AreaAware Dismounted receives events from AreaAware Server  \\
	\hline
\end{longtable}

\begin{longtable}{| p{3.5cm} |  p{10cm} | }
	\hline
	\textbf{EI-08} &  \textbf{SINE interface} \\
	\hline
	Version & v0.1 \\
	\hline
	Status & Under development \\
	\hline
	Description & The AreaAware Dismounted Will communicate over the SINE network via \emph{ICCS}\citep{iccs}. AreaAware Dismounted should be able to receive messages from \emph{ICCS} and distributes these to relevant parties through the \emph{ICCS}.  AreaAware Dismounted should be able to send events to \emph{ICCS}.
	\\
	\hline
	Needed interfaces 
	& AreaAware Dismounted receives messages from \emph{ICCS} \\
	& AreaAware Dismounted distributes messages to \emph{ICCS} \\
	& AreaAware Dismounted sends different types of events to \emph{ICCS} \\
	& AreaAware Dismounted receives different types of events from \emph{ICCS} \\
	\hline
\end{longtable}

\begin{longtable}{| p{3.5cm} |  p{10cm} | }
	\hline
	\textbf{EI-09} &  \textbf{Commercial internet interface} \\
	\hline
	Version & v0.1 \\
	\hline
	Status & Under development \\
	\hline
	Description & The AreaAware Dismounted Will communicate over the \emph{commercial internet}.
	\\
	\hline
	Needed interfaces 
	& AreaAware Dismounted receives messages from AreaAware HQ and AreaAware Server via \emph{commercial internet} \\
	& AreaAware Dismounted distributes messages to AreaAware HQ and AreaAware Server via \emph{commercial internet} \\ 
	& AreaAware Dismounted sends different types of events to AreaAware HQ and AreaAware Server via \emph{commercial internet} \\
	& AreaAware Dismounted receives different types of events from AreaAware HQ and AreaAware Server via \emph{commercial internet} \\
	\hline
\end{longtable}
