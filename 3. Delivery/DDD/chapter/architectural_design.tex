...
\begin{tabular}{l|*{2}{l}}
    ...
    Design decisions & \makecell[l]{D-HQ1, D-HQ2, D-HQ3,\\ D-HQ4} & AreaAware-DDD-20160214-01-01 \\
\end{tabular}\\\\
...
\begin{tabular}{l|*{2}{l}}
    ...
    Design decisions & D-HQ1, D-HQ2, D-HQ4 & AreaAware-DDD-20160214-01-01 \\
\end{tabular}\\\\

\subsubsection{Comunication Modem}
\begin{tabular}{l|*{2}{l}}
    ...
    Design decisions & D-HQ3 & AreaAware-DDD-20160214-01-01 \\
\end{tabular}\\\\
...
\subsubsection{Web Presenter Communicator}
\begin{tabular}{l|*{2}{l}}
...
\subsubsection{SINE Communicator}
\begin{tabular}{l|*{2}{l}}
...
\subsubsection{Commercial Internet Communicator}
\begin{tabular}{l|*{2}{l}}
...
\subsubsection{Communicator Controller}
\begin{tabular}{l|*{2}{l}}
