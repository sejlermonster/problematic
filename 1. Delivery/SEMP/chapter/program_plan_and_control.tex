...
In Project FOOBAR\todo{Projekt navn?}, Systematic wishes to extend these possibilities offered by \emph{SitaWare Suite} to cover civilian scenarios, where actors for police, armed forces, hospitals and emergency management work together to control a crisis situation.
...
The objective of Project FOOBAR\todo{Projekt navn?} is to deliver a solution capable of forfilling the successful result described above in \ref{sec:sow_intro}.
