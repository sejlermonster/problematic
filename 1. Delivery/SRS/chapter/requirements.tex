...
%	\hline
%	Task & Deployed actor registers event \\
%	Purpose & Let deployed actors register events \\
%	Trigger/ &  \\ Precondition & An actor is deployed in the area with access to the platform \\
%	\hline
%	Sub-Tasks: & \\
%	1. & Deployed actor observes event \\
%	2. & Deployed actor registers event on platform \\
%	3. & Platform sends registered event to the Track Server \\
%	\hline
%	Variants: & \\
%	2b. & Platform is offline \\
%	\hline
%\end{longtable}
...
%\begin{longtable}{| p{2.5cm}  | p{10cm} |  }
%	\hline
%	Task & Deployed actor location changed \\
%	Purpose & Send information about deployed actors location \\
%	Trigger/ &  \\ Precondition & Actor deployed in the area \\
%	Frequency & Last location changed with approximately 10 meters \\
%	\hline
%	Sub-Tasks: & \\
%	1. & Deployed actor changes location \\
%	2. & Platform registers location changed \\
%	3. & Platform sends registered location to the Track Server \\
%	\hline
%	Variants: & \\
%	2b. & Platform is offline \\
%	\hline
...
\subsection{Armed forces system}
